...
public class Stanza {
	...
	static final private int NUMERO_MASSIMO_ATTREZZI = 10; // prec:10 - per semplicità nelle classi di test
	...
	public boolean removeAttrezzo(Attrezzo attrezzo) {
		...
		for (int i=0; i<this.numeroAttrezzi; i++) {
			if (this.attrezzi[i] == attrezzo) { // il confronto viene eseguito sui riferimenti
				this.attrezzi[i] = this.attrezzi[numeroAttrezzi - 1]; //sovrascrivo il riferimento i dell'attrezzo da rimuovere
